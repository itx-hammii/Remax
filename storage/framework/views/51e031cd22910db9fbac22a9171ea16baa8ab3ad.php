<?php $__env->startSection('title','Remax - Home'); ?>
<?php $__env->startSection('content'); ?>
                ...
                <nav style="background-color: #14537b8c; height:90px; " class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="#">
                            <img src="<?php echo e(asset('img/logo-rwb.svg')); ?>" alt="Remax logo image">
                        </a>
                        <a href="<?php echo e(route('first.step')); ?>" style="border-radius: 0; " class="btn btn-primary">Get
                            Started</a>
                    </div>
                </nav>
            </div>
        ...
        <div class=" uppertxt container h-100">
            <div class="d-flex text-center h-100">
                <div class="my-auto w-100 text-white">
                    ...
                    <a href="<?php echo e(route('first.step')); ?>" style="border-radius: 0; z-index: 2;" class="btn btn-primary">Get
                        Started</a>
    ...
    <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
        <source src="<?php echo e(asset('img/jr_vid_bg.mp4-vimeo-778597626-hls-akfire_interconnect_quic_sep-4430.mp4')); ?>"
                type="video/mp4">
    </video>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/triixa/Learn/Remax/resources/views/home/index.blade.php ENDPATH**/ ?>